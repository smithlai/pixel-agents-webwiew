...
export const TOOL_OVERLAY_ACTIVITY_FONT_PX = 13;
export const TOOL_OVERLAY_ACTIVITY_PADDING_Y_PX = 4;
export const TOOL_OVERLAY_ACTIVITY_PADDING_X_PX = 10;
export const TOOL_OVERLAY_NAME_FONT_PX = 13;
export const TOOL_OVERLAY_SUB_NAME_FONT_PX = 12;
export const SPEECH_BUBBLE_FONT_MIN_PX = 12;
export const SPEECH_BUBBLE_FONT_ZOOM_FACTOR = 3.6;
